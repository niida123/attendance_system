                            ...
                            <table id="shiftTable" class="table table-hover w-100 mb-0" style="min-width:750px;">
                                <thead>
                                    <tr style="background:#f8f9ff;">
                                        ...
                                        <th style="padding:14px 20px;font-size:.75rem;font-weight:700;text-transform:uppercase;letter-spacing:.6px;color:#6b7280;border-bottom:2px solid #eef0f8;border-top:none;">Shift Name</th>
                                        <th style="padding:14px 20px;font-size:.75rem;font-weight:700;text-transform:uppercase;letter-spacing:.6px;color:#6b7280;border-bottom:2px solid #eef0f8;border-top:none;">Start Time</th>
                                        <th style="padding:14px 20px;font-size:.75rem;font-weight:700;text-transform:uppercase;letter-spacing:.6px;color:#6b7280;border-bottom:2px solid #eef0f8;border-top:none;">End Time</th>
                                        <th style="padding:14px 20px;font-size:.75rem;font-weight:700;text-transform:uppercase;letter-spacing:.6px;color:#6b7280;border-bottom:2px solid #eef0f8;border-top:none;">Late After</th>
                                        <th style="padding:14px 20px;font-size:.75rem;font-weight:700;text-transform:uppercase;letter-spacing:.6px;color:#6b7280;border-bottom:2px solid #eef0f8;border-top:none;">Work Hours</th>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                <label for="shift_name" style="font-weight:600;font-size:.83rem;color:#374151;letter-spacing:.2px;margin-bottom:6px;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                <label for="start_time" style="font-weight:600;font-size:.83rem;color:#374151;letter-spacing:.2px;margin-bottom:6px;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                <label for="end_time" style="font-weight:600;font-size:.83rem;color:#374151;letter-spacing:.2px;margin-bottom:6px;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                <label for="late_after_minutes" style="font-weight:600;font-size:.83rem;color:#374151;letter-spacing:.2px;margin-bottom:6px;">
                                    LATE AFTER <span class="text-danger">*</span>
                                </label>
                                <input type="number" id="late_after_minutes" class="form-control" placeholder="e.g. 15 mins"
                                    style="border-radius:10px;border:1.5px solid #e5e7eb;padding:10px 14px;font-size:.9rem;" min="0">
                        ...
                        <div class="col-md-6">
                            <div class="form-group
                                mb-4">
                                <label for="working_hours" style="font-weight:600;font-size:.83rem;color:#374151;letter-spacing:.2px;margin-bottom:6px;">
                                    WORK HOURS <span class="text-danger">*</span>
                                </label>
                                <input type="number" id="working_hours" class="form-control" placeholder="e.g. 8"
                                    style="border-radius:10px;border:1.5px solid #e5e7eb;padding:10px 14px;font-size:.9rem;" min="0" step="0.5">
...
@section('css')
    ...
    <style>
        ...
        #shiftTable tbody tr { transition: background .15s; }
        #shiftTable tbody tr:hover { background: #f5f6ff !important; }
        #shiftTable tbody td {
            padding: 13px 20px;
            ...
            const table = $('#shiftTable').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        data: 'shift_name',
                        render: shift_name =>
                            `<span style="font-weight:600;color:#1a1f36;">${shift_name}</span>`
                    },
                    {
                        data: 'start_time',
                        render: (start_time, type) => {
                            ...
                            return `<span style="color:#6b7280;">${formatTime12Hour(start_time)}</span>`;
                        }
                    },
                    {
                        data: 'end_time',
                        render: (end_time, type) => {
                            ...
                            return `<span style="color:#6b7280;">${formatTime12Hour(end_time)}</span>`;
                        }
                    },
                    {
