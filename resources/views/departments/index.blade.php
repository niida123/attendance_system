    ...
    <div class="d-flex align-items-center justify-content-between">
        <div>
            <h1 class="m-0 font-weight-bold" style="color:#1a1f36;font-size:1.4rem;letter-spacing:-0.3px;">
                <i class="fas fa-building mr-2" style="color:#4f46e5;"></i> Departments
            </h1>
            <ol class="breadcrumb mt-1 mb-0" style="background:transparent;padding:0;font-size:.8rem;">
                ...
                <li class="breadcrumb-item active" style="color:#6b7280;">Departments</li>
            </ol>
        </div>
    </div>
@stop
            ...
            <div class="card"
                ...
                <div class="card-body" style="padding:24px;background:#fafbff;">
                        ...
                        <div class="col-md-4 mb-3 mb-md-0">
                            <div
                                ...
                                <div>
                                    ...
                                    <div style="font-size:.75rem;color:#9ca3af;margin-top:2px;">Total Departments</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3 mb-md-0">
                    ...
                    <div style="background:#fff;border-radius:12px;border:1px solid #f0f0f5;overflow:hidden;">
                        ...
                        <table id="departmentTable" class="table table-hover w-100 mb-0" style="min-width:700px;">
                            <thead>
            ...
            <div class="modal-content"
                ...
                <div class="modal-body" style="padding:28px 24px;background:#fff;">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <span class="text-danger small d-block mt-1" id="err_department_name"></span>
                    </div>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            const BASE_URL = '{{ route('departments.index') }}';
            const DATA_URL = '{{ url('departments/data') }}';
            ...
            const table = $('#departmentTable').DataTable({
                ...
                language: {
                    ...
                    emptyTable: '<div style="padding:40px 0;color:#9ca3af;"><i class="fas fa-inbox" style="font-size:2rem;display:block;margin-bottom:10px;opacity:.4;"></i>No departments found.</div>',
                    info: 'Showing _START_–_END_ of <strong>_TOTAL_</strong> departments',
                    paginate: {
                    ...
                    },
                    {
                        ...
                        <div class="d-flex align-items-center justify-content-center" style="gap:6px;">
                            ...
                            <button type="button" class="btn-delete-row btn-delete"
                                    data-id="${id}" data-name="${row.department_name}"
            ...
            $(document).on('click', '.btn-edit', function() {
                ...
                $.get(BASE_URL + '/' + id)
                    ...
                    .fail(function() {
                        ...
                        setTimeout(() => $('#departmentModal').modal('hide'), 1500);
                    })
                    .always(function() {
            ...
            /* ── Modal close: reset ─────────────────────────────────── */
            $('#departmentModal').on('hidden.bs.modal', resetForm);

            /* ── Helpers ────────────────────────────────────────────── */
            function resetForm() {
                $('#department_id, #department_name, #description').val('');
                $('#status').val('');
                clearErrors();
            }

            function clearErrors() {
                ['department_name', 'description', 'status'].forEach(function(f) {
