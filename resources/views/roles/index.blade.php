    ...
    <div class="d-flex align-items-center justify-content-between">
        <div>
            <h1 class="m-0 font-weight-bold" style="color:#1a1f36;font-size:1.4rem;letter-spacing:-0.3px;">
                <i class="fas fa-user-tag mr-2" style="color:#4f46e5;"></i> Roles
            </h1>
            <ol class="breadcrumb mt-1 mb-0" style="background:transparent;padding:0;font-size:.8rem;">
                ...
                <li class="breadcrumb-item active" style="color:#6b7280;">Roles</li>
            </ol>
        </div>
    </div>
@stop
                        ...
                        <div class="col-md-4 mb-3 mb-md-0">
                            <div
                                ...
                                <div>
                                    ...
                                    <div style="font-size:.75rem;color:#9ca3af;margin-top:2px;">Total Roles</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3 mb-md-0">
                ...
                <div class="modal-header"
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <h5 class="modal-title text-white mb-0 font-weight-bold" style="font-size:1rem;">
                            <span id="modalTitle">Add Role</span>
                        </h5>
                    </div>
                ...
                <div class="modal-body" style="padding:28px 24px;background:#fff;">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <textarea id="description" class="form-control" rows="3"
                            placeholder="Brief description of this role (optional)"
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            const BASE_URL = '{{ route('roles.index') }}';
            const DATA_URL = '{{ url('roles/data') }}';
            ...
            const table = $('#roleTable').DataTable({
                ...
                language: {
                    ...
                    emptyTable: '<div style="padding:40px 0;color:#9ca3af;"><i class="fas fa-inbox" style="font-size:2rem;display:block;margin-bottom:10px;opacity:.4;"></i>No roles found.</div>',
                    info: 'Showing _START_–_END_ of <strong>_TOTAL_</strong> roles',
                    paginate: {
            ...
            $(document).on('click', '.btn-edit', function() {
                ...
                $.get(BASE_URL + '/' + id)
                    ...
                    .fail(function() {
                        ...
                        setTimeout(() => $('#roleModal').modal('hide'), 1500);
                    })
                    .always(function() {
